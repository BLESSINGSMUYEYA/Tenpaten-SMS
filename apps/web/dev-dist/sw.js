...
define(['./workbox-b5b81451'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.3ur86k5llrs"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\/api\/attendance\/mark/, new workbox.NetworkOnly({
    plugins: [new workbox.BackgroundSyncPlugin("attendance-mark-queue", {
      maxRetentionTime: 10080
    })]
  }), 'POST');
