      ...
      author: authorName
          ...
          const heroMetrics = [
            ...(school?.featuresAttendance !== false ? [{
              ...
              value: loadingTimetable ? '...' : totalSlotsCount > 0 ? `${totalSlotsCount} Slots Scheduled` : 'No slots scheduled',
            ...
            ...(school?.featuresGrades !== false ? [
              {
                ...
                value: loadingGrades ? '...' : `${gradeSubmissionRate}% Received`,
                icon: 'upload_file',
                bg: 'bg-primary-container text-primary'
              },
              {
                label: 'Pending Approvals',
                value: loadingGrades ? '...' : `${pendingApprovalsCount} Actions`,
              ...
              <main className="lg:ml-72 pt-20 pb-24 lg:pb-8 px-margin-mobile md:px-margin-desktop min-h-screen bg-surface text-on-surface transition-colors">
                ...
                <div className="space-y-lg">
                  ...
                  {heroMetrics.length > 0 && (
                    <div className={`grid grid-cols-1 md:grid-cols-${heroMetrics.length} gap-lg cards-stagger`}>
                      {heroMetrics.map((c, i) => (
                        <div key={i} className="bg-surface-container-lowest border border-outline-variant p-lg rounded-xl shadow-sm flex items-center gap-md">
                          ...
                          <div>
                            ...
                            <p className={`font-headline-sm text-headline-sm ${c.valColor || 'text-primary'} mt-1 font-bold`}>
                              {c.value}
                            </p>
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg">
            {/* Left Column */}
            <div className={`col-span-12 ${school?.featuresCommunication !== false ? 'lg:col-span-8' : ''} space-y-lg`}>
