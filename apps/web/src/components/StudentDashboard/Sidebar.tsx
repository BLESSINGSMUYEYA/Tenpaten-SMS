  ...
  return (
    <>
      ...
      <div className="px-4 mb-8 flex flex-col items-center text-center">
        <Logo height="52px" className="mb-1" />
      </div>
      <nav className="flex-1 space-y-2">
        <Link to="/student/dashboard" className="flex items-center gap-4 px-4 py-3 bg-primary-container text-on-primary-container rounded-lg font-bold">
